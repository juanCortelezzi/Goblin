defmodule Proto do
  ...
  ## Examples
    ...
    iex> Proto.from_binary(<<1, 0, 0>>)
    {:ok, {%Proto{version: 1, type: :echo, length: 0, payload: ""}, ""}}

    iex> Proto.from_binary(<<1, 0, 2, "hi">>)
    {:ok, {%Proto{version: 1, type: :echo, length: 2, payload: "hi"}, ""}}
